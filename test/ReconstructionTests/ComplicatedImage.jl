# Here the test is done with some natural grayscale image that is reconstructed under use of a Neural regularizer.
...
@testset "Reconstruction Complicated Image" begin
